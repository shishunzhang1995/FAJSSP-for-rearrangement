...
from env_dag.load_data import get_index
...
class HGNNScheduler(nn.Module):
    ...
    def get_action_prob(self, state, memories, flag_sample=False, flag_train=False):
        ...
        eligible_proc=state.ope_ma_adj_batch
        # print("eligible_proc=",eligible_proc)
        ...
        ope_eligible=ope_eligible.unsqueeze(0)
        print("ope_eligible=", ope_eligible)
        print("ope_eligible=", ope_eligible.size())
        ope_eligible = ope_eligible.expand_as(h_opes_padding[..., 0])  ##
        print("ope_eligible=",ope_eligible)
        print("ope_eligible=", ope_eligible.size())
