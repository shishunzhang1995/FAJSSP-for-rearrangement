...
def load_fjs(lines, num_mas, num_opes):
    ...
    '''
    flag = 0
    matrix_proc_time = torch.zeros(size=(num_opes, num_mas)) ## [26,5]
    matrix_pre_proc = torch.full(size=(num_opes, num_opes), dtype=torch.bool, fill_value=False) ##[26,26], pre_porc_relation
    ...
    for line in lines:
        ...
        # other
            ...
            # print("num_ope_bias=",num_ope_bias)
            num_ope_biases.append(num_ope_bias)
            # print("num_ope_biases=", num_ope_biases)
    ...
    # print("num_ope_biases=", num_ope_biases)
    # print("nums_ope=", nums_ope)
    # print("matrix_cal_cumul=", matrix_cal_cumul)
